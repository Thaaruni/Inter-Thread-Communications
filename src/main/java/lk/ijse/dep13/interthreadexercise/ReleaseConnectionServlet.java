...
public class ReleaseConnectionServlet extends HttpServlet {
    ...
    private synchronized void releaseConnection(String id, HttpServletResponse resp) throws IOException {
    ...
    private synchronized void releaseAllConnections(HttpServletResponse resp) throws IOException {
        NurseryCP connectionPool = (NurseryCP) getServletContext().getAttribute("datasource");
